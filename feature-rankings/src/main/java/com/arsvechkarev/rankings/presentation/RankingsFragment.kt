...
class RankingsFragment : BaseFragment(R.layout.fragment_rankings) {
  ...
  override fun onInit() {
    viewModel = RankingsComponent.provideViewModel(this).also { model ->
  ...
  private fun setupChips() {
    ...
    chipHelper = ChipHelper(groupOptionTypes, groupWorldRegions,
      onNewChipSelected = viewModel::filter,
  ...
  private fun goBackFromCountryInfo() {
    ...
    rankingsDialog.animateInvisible(andThen = { rankingsRecyclerView.isEnabled = true })
  }

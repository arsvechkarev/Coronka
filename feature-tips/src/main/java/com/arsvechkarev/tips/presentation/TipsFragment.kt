...
import base.resources.Styles.BaseTextView
import base.resources.Styles.BoldTextView
import base.resources.Styles.HeaderTextView
import base.resources.TextSizes
import base.views.CustomRecyclerView
import base.views.PreventionView
import base.views.SymptomsView
import com.arsvechkarev.recycler.StaticDelegateBuilder
...
class TipsFragment : BaseFragment() {
  ...
  private fun symptomsLayout(): StaticDelegateBuilder<SymptomsItem>.() -> Unit = {
    data(SymptomsItem)
    view { parent ->
      SymptomsView(parent.context).apply {
        paddings(
